...
class Modelo_consultas
{
    ...
    public function buscarOrdenesSistema($u)
    {
        ...
        if($u == 0){
        		...
        		$sql = "SELECT * FROM solicitudes_mantenimiento JOIN novedad_sistema ON solicitudes_mantenimiento.descripcion1 = novedad_sistema.id WHERE solicitudes_mantenimiento.estado <> 'Eliminado' AND solicitudes_mantenimiento.cod_sistema = '".$u."' ORDER BY solicitudes_mantenimiento.numero_solicitud DESC;";
        }
        $l_stmt = $this->conexion->prepare($sql);
        if (!$l_stmt)
        {
    ...
    public function buscarOrdenesSistemaCampus($u, $c)
    {
        ...
        if($u == 0){
                ...
                $sql = "SELECT * FROM solicitudes_mantenimiento JOIN novedad_sistema ON solicitudes_mantenimiento.descripcion1 = novedad_sistema.id WHERE solicitudes_mantenimiento.estado <> 'Eliminado' AND solicitudes_mantenimiento.cod_sistema = '".$u."' AND solicitudes_mantenimiento.codigo_campus = '".$c."' ORDER BY solicitudes_mantenimiento.numero_solicitud DESC;";       
        }
        $l_stmt = $this->conexion->prepare($sql);
        if (!$l_stmt)
        {
    ...
    public function buscarOrdenesParametros($c, $s, $fi, $ff)
    {
        ...
        if($c == 4){
            if($s == 5){
                ...
                $sql = "SELECT * FROM solicitudes_mantenimiento JOIN novedad_sistema ON solicitudes_mantenimiento.descripcion1 = novedad_sistema.id WHERE solicitudes_mantenimiento.cod_sistema = '".$s."' AND solicitudes_mantenimiento.fecha BETWEEN '".$fi."' AND '".$ff."' ORDER BY solicitudes_mantenimiento.numero_solicitud;";
            }            
        }else{
            if($s == 5){
                $sql = "SELECT * FROM solicitudes_mantenimiento WHERE codigo_campus = '".$c."' AND fecha BETWEEN '".$fi."' AND '".$ff."' ORDER BY numero_solicitud;";
            }else{
                $sql = "SELECT * FROM solicitudes_mantenimiento JOIN novedad_sistema ON solicitudes_mantenimiento.descripcion1 = novedad_sistema.id WHERE solicitudes_mantenimiento.codigo_campus = '".$c."' AND solicitudes_mantenimiento.cod_sistema = '".$s."' AND solicitudes_mantenimiento.fecha BETWEEN '".$fi."' AND '".$ff."' ORDER BY solicitudes_mantenimiento.numero_solicitud;";
            }            
        }                
     ...
     */
    public function buscarOrdenesParametrosAvanzados($c, $e, $s, $fi, $ff){
        $c = htmlspecialchars(trim($c));
        ...
        if($e == "TODOS"){
            ...
            if($s == 5){
                ...
                $sql = "SELECT * FROM solicitudes_mantenimiento JOIN novedad_sistema ON solicitudes_mantenimiento.descripcion1 = novedad_sistema.id WHERE solicitudes_mantenimiento.fecha BETWEEN '".$fi."' AND '".$ff."' AND solicitudes_mantenimiento.codigo_campus = '".$c."' AND solicitudes_mantenimiento.codigo_edificio = '".$e."' AND novedad_sistemacod_sistema = '".$s."' AND solicitudes_mantenimiento.estado <> 'Eliminado' ORDER BY solicitudes_mantenimiento.numero_solicitud DESC;";
            }
		  }
        $l_stmt = $this->conexion->prepare($sql);
    ...
    public function buscarUsuario($l){
        ...
        $sql = "SELECT nombre_usuario,telefono,extension FROM usuarios_autorizados_sistema WHERE login = '".$l."' LIMIT 1;";
    ...
    public function buscarDBEdificio($p){
        ...
        if($p == 01)
        {
            $sql = "SELECT codigo,nombre FROM edificiomelendez ORDER BY codigo;";
            $l_stmt = $this->conexion->prepare($sql);
            if (!$l_stmt){
                $GLOBALS['mensaje'] = MJ_PREPARAR_CONSULTA_FALLIDA;
            }
        ...
        if($p == 02){
            $sql = "SELECT codigo,nombre FROM edifsanfernando ORDER BY codigo;";
            $l_stmt = $this->conexion->prepare($sql);
            if (!$l_stmt){
                $GLOBALS['mensaje'] = MJ_PREPARAR_CONSULTA_FALLIDA;
            }
        ...
        if($p == 03){
            $sql = "SELECT codigo,nombre FROM otrosespacios ORDER BY codigo;";
            $l_stmt = $this->conexion->prepare($sql);
            if (!$l_stmt){
                $GLOBALS['mensaje'] = MJ_PREPARAR_CONSULTA_FALLIDA;
            }
