...
class Controlador_vista
{
    ...
    function __construct() {
        ...
        $diccionario = array(           
            'links_menu'=>array(
                ...
                'LIST_CONSULTAS_S'=>'index.php?action='.OPERATION_LIST_S.'_'.CONSULTAS,
    ...
    **/
    ...
    {
        $link = "<script type='text/javascript' src='vista/js/".$module."_functions.js'></script>";
    ...
    **/
    ...
    {
        $file = dirname(dirname(__FILE__)).'/vista/templates/operaciones/'.'operaciones_sanfernando.html';
        ...
        /*if(strcmp($perfil, 'sanfernando') == 0){
            ...
            $file = dirname(dirname(__FILE__)).'/vista/templates/operaciones/'.'operaciones_jefe.html';
        }
        else if(strcmp($perfil, 'jefe') == 0){
            $file = dirname(dirname(__FILE__)).'/vista/templates/operaciones/'.'operaciones_jefeTodos.html';
        }
        else if(strcmp($perfil, 'admin') == 0){
        	$file = dirname(dirname(__FILE__)).'/vista/templates/operaciones/'.'operaciones_admin.html';
        }
        else{
            $file = dirname(dirname(__FILE__)).'/vista/templates/operaciones/'.'operaciones_normal.html';
        }*/
    ...
    **/
    ...
    {        
        if(strcmp($module, 'plantilla') == 0 || strcmp($module, 'plantilla2') == 0)
        {
            $file = dirname(dirname(__FILE__)).'/vista/templates/'.$module.'.html';
        }
        else
        {
            $file = dirname(dirname(__FILE__)).'/vista/templates/vistas_'.$module.'/'
    ...
    **/
    function retornar_vista($perfil, $module, $operation, $data=array()) {
        ...
        {
            $html = $this->conseguir_plantilla('plantilla2', '');
        ...
        {
            $html = $this->conseguir_plantilla('plantilla', '');
