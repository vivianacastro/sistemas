...
class Modelo_usuario {
     ...
     * @return boolean
     */
    public function modificarPerfilUsuarioAutorizado($id, $p) {
     ...
     * @return boolean
     */
    public function eliminarUsuarioAutorizado($id=array()) {
    ...
    public function comprobarAcceso($login, $password) {
        ...
        $sql = "SELECT id,nombre_usuario,login,perfil,correo,telefono,extension FROM usuarios WHERE login = '".$login."' AND 
