/* Función que permite la paginación de las tablas */
...
$(document).ready(function() {
    ...
    **/
    ...
    /**
     * Se captura el evento cuando se modifica el valor del input nombre_articulo_search.
    **/
    ...
    **/
    ...
    /**
     * Se captura el evento cuando se modifica el valor del input nombre_marca_search.
    **/
    $("#nombre_marca_search").change(function (e) {
        if (validarCadena($("#nombre_marca_search").val())) {
            $('#visualizarMarcaInventario').removeAttr("disabled");
        }else{
    ...
    **/
    $("#nombre_proveedor_search").change(function (e) {
        if (validarCadena($("#nombre_proveedor_search").val())) {
            $('#visualizarProveedor').removeAttr("disabled");
        }else{
    ...
    **/
    ...
    /**
     * Se captura el evento cuando se da click en el botón visualizarArticulo y se
     * realiza la operacion correspondiente.
    **/
