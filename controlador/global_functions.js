...
$(document).ready(function () {
	...
	if(URLactual['href'].indexOf('menu_principal') >= 0 || URLactual['href'].indexOf('iniciar_sesion') >= 0){
		...
		}else if ((URLactual['href'].indexOf('inventario_crear_subcategoria') >= 0)) {
			$('#option_crear_subcategoria').addClass("opcion_activa_seleccion");
		...
		}else if ((URLactual['href'].indexOf('inventario_consultar_subcategoria') >= 0)) {
			$('#option_consultar_subcategoria').addClass("opcion_activa_seleccion");
